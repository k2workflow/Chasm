...
namespace SourceCode.Chasm.IO.Json.Tests
{
    public static partial class CommitTests // .Message
    {
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Null))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Null()
        {
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Empty))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Empty()
        {
            var ser = new JsonChasmSerializer();
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Whitespace))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Whitespace()
        {
            var ser = new JsonChasmSerializer();
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Short))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Short()
        {
            var ser = new JsonChasmSerializer();
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Long))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Long()
        {
            var ser = new JsonChasmSerializer();
        ...
        [Trait("Type", "Unit")]
        [Fact(DisplayName = nameof(JsonChasmSerializer_Roundtrip_Commit_Message_Wide))]
        public static void JsonChasmSerializer_Roundtrip_Commit_Message_Wide()
        {
            var ser = new JsonChasmSerializer();
