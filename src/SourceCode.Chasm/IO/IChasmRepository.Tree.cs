...
namespace SourceCode.Chasm.IO
{
    ...
    public partial interface IChasmRepository // .Tree
    {
        ...
        ValueTask<CommitId> WriteTreeAsync(IReadOnlyList<CommitId> parents, TreeNodeMap tree, Audit author, Audit committer, string message, string tenantId, CancellationToken cancellationToken);
